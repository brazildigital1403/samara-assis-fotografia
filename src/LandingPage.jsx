...
const LANDING_CSS = `
  ...
  .lp-header-inner { max-width: 1600px; margin: 0 auto; display: flex; align-items: center; justify-content: space-between; gap: 1rem; padding: 0.875rem 1.25rem; min-height: 64px; }
  ...
  /* HERO */
  .lp-hero { padding: 5rem 1.5rem 4rem; text-align: center; border-bottom: 1px solid #f0f0f0; background-image: linear-gradient(180deg, rgba(255,255,255,0.88) 0%, rgba(255,255,255,0.94) 100%), url('https://static.wixstatic.com/media/b45ddb_09d55f828ea94bbbabb68b1e4c779cf8~mv2.png/v1/fill/w_970,h_647,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/b45ddb_09d55f828ea94bbbabb68b1e4c779cf8~mv2.png'); background-size: cover; background-position: center; background-repeat: no-repeat; }
  ...
  .lp-section { padding: 4rem 1.5rem; max-width: 1200px; margin: 0 auto; scroll-margin-top: 80px; }
  .lp-section-wide { padding: 4rem 0; max-width: none; scroll-margin-top: 80px; }
  .lp-section-wide-inner { max-width: 1200px; margin: 0 auto; padding: 0 1.5rem; }
